...
class Sessao:
    ...
    def __eq__(self, other: object) -> bool:
        """Verify equality between Sessao instances."""
        if not isinstance(other, Sessao):
            return False
        return (
            self.codigo == other.codigo
            and getattr(self.sala, "numero", None) == getattr(other.sala, "numero", None)
            and getattr(self.filme, "codigo", None) == getattr(other.filme, "codigo", None)
